...
public class StandardPropertiesSourceFactoryTests {
    ...
    @Test
    public void create() {
        List<PropertiesSource> properties = this.factory.create("src/test/resources/test.properties", new Properties());
        assertEquals(3, properties.size());
    }

    @Test
    public void propertiesPathNull() {
        List<PropertiesSource> properties = this.factory.create(null, new Properties());
