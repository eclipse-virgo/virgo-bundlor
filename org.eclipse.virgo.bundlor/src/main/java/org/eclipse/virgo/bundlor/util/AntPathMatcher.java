...
import org.eclipse.virgo.bundlor.util.PathMatcher;
...
public class AntPathMatcher implements PathMatcher {
     ...
     * </ul>
     * <p>
     * Assumes that {@link #match} returns <code>true</code> for '<code>pattern</code>' and '<code>path</code>', but
     ...
     * match (such as {@code *.html}. In that case, the second pattern should be included in the first, or an {@code
