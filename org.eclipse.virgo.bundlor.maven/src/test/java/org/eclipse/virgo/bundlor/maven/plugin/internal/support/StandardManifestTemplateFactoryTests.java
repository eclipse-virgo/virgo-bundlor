...
public class StandardManifestTemplateFactoryTests {
    ...
    public void manifestTemplatePath() {
        ManifestContents template = this.factory.create("src/test/resources/test-template.mf", null, SYMBOLIC_NAME, null, VERSION, null);
    ...
    public void manifestTemplate() {
        ManifestContents template = this.factory.create(null, "Manifest-Version: 1.0", SYMBOLIC_NAME, null, VERSION, null);
        assertNotNull(template.getMainAttributes().get("Bundle-SymbolicName"));
        assertNotNull(template.getMainAttributes().get("Bundle-Version"));
    }
    ...
    public void manifestTemplateDefaults() {
        ManifestContents template = this.factory.create(null, "Manifest-Version: 1.0", null, SYMBOLIC_NAME, null, VERSION);
        assertNotNull(template.getMainAttributes().get("Bundle-SymbolicName"));
        assertNotNull(template.getMainAttributes().get("Bundle-Version"));
    }
    ...
    public void manifestTemplateNull() {
        ManifestContents template = this.factory.create(null, null, SYMBOLIC_NAME, null, VERSION, null);
        assertNotNull(template.getMainAttributes().get("Bundle-SymbolicName"));
        assertNotNull(template.getMainAttributes().get("Bundle-Version"));
    }
}
